...
internal class R89VideoInterstitial(
	private val osAdObject: IR89VideoInterstitialOS,
...
) : R89AdObject()
{
	...
	private fun createInternalEventListener(): InterstitialEventListenerInternal
	{
		return object : InterstitialEventListenerInternal
		{
			...
			{
				R89LogUtil.e(TAG, "Ad failed to load: $error", false)
				invalidate()
				loading = false
				finishLoadingCycle = true
	...
	{
		private const val TAG = "videointerstitial"
		...
		{
			return "Video Interstitial is invalid because: " +
