...
@class RSDKR89SDK, RSDKInitializationEvents, RSDKConfigBuilder, RSDKLogLevels, RSDKRefineryAdFactory, UIView, RSDKBannerEventListener, RSDKInfiniteScrollEventListener, UIViewController, RSDKInterstitialEventListener, RSDKR89LoadError, RSDKRewardItem, RSDKAdScreenBuilder, RSDKConfigBuilderCompanion, RSDKKotlinPair<__covariant A, __covariant B>, RSDKWrapperPosition, RSDKKotlinIntRange, RSDKSingleTagConfigBuilder, RSDKKotlinEnumCompanion, RSDKKotlinEnum<E>, RSDKKotlinArray<T>, UITableView, UIControl, RSDKKotlinIntProgressionCompanion, RSDKKotlinIntIterator, RSDKKotlinIntProgression, RSDKKotlinIntRangeCompanion;
 ...
 * what happened.
 */
__attribute__((swift_name("NativeEventListener")))
@interface RSDKNativeEventListener : RSDKBase
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AdScreenBuilder")))
@interface RSDKAdScreenBuilder : RSDKBase
- (instancetype)initWithIsFragment:(BOOL)isFragment screenName:(NSString *)screenName __attribute__((swift_name("init(isFragment:screenName:)"))) __attribute__((objc_designated_initializer));
- (RSDKAdScreenBuilder *)addBannerR89ConfigId:(NSString *)r89ConfigId wrapperTag:(NSString *)wrapperTag getAllWithTag:(BOOL)getAllWithTag wrapperRelativePositionInside:(BOOL)wrapperRelativePositionInside __attribute__((swift_name("addBanner(r89ConfigId:wrapperTag:getAllWithTag:wrapperRelativePositionInside:)")));
- (RSDKAdScreenBuilder *)addInfiniteScrollR89ConfigId:(NSString *)r89ConfigId wrapperTag:(NSString *)wrapperTag getAllWithTag:(BOOL)getAllWithTag infiniteScrollItemWrapper:(NSString *)infiniteScrollItemWrapper __attribute__((swift_name("addInfiniteScroll(r89ConfigId:wrapperTag:getAllWithTag:infiniteScrollItemWrapper:)")));
- (RSDKAdScreenBuilder *)addInterstitialR89ConfigId:(NSString *)r89ConfigId eventsToTrackTo:(NSString * _Nullable)eventsToTrackTo eventsToTrackButton:(NSString * _Nullable)eventsToTrackButton __attribute__((swift_name("addInterstitial(r89ConfigId:eventsToTrackTo:eventsToTrackButton:)")));
@property (readonly) BOOL isFragment __attribute__((swift_name("isFragment")));
...
@property (readonly) NSString *NATIVE_TEST_R89_CONFIG_ID __attribute__((swift_name("NATIVE_TEST_R89_CONFIG_ID")));
@property (readonly) NSString *NATIVE_TEST_UNIT_ID __attribute__((swift_name("NATIVE_TEST_UNIT_ID")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SingleTagConfigBuilder")))
@interface RSDKSingleTagConfigBuilder : RSDKBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)singleTagConfigBuilder __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) RSDKSingleTagConfigBuilder *shared __attribute__((swift_name("shared")));
- (RSDKAdScreenBuilder *)addAdScreenBuilderIsFragment:(BOOL)isFragment screenName:(NSString *)screenName __attribute__((swift_name("addAdScreenBuilder(isFragment:screenName:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("R89DynamicInfiniteScrollIosImpl")))
@interface RSDKR89DynamicInfiniteScrollIosImpl : RSDKBase
- (instancetype)initWithUiTableView:(UITableView *)uiTableView __attribute__((swift_name("init(uiTableView:)"))) __attribute__((objc_designated_initializer));
- (void)setOnScrollChildrenChangedScrollItemAdWrapperTag:(NSString *)scrollItemAdWrapperTag onChildAdded:(void (^)(RSDKInt *, id))onChildAdded onChildDoesNotHaveWrapper:(void (^)(RSDKInt *))onChildDoesNotHaveWrapper onChildRemoved:(void (^)(RSDKInt *))onChildRemoved __attribute__((swift_name("setOnScrollChildrenChanged(scrollItemAdWrapperTag:onChildAdded:onChildDoesNotHaveWrapper:onChildRemoved:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("UIControlExtKt")))
@interface RSDKUIControlExtKt : RSDKBase
+ (void)removeAllTargets:(UIControl *)receiver __attribute__((swift_name("removeAllTargets(_:)")));
@end
