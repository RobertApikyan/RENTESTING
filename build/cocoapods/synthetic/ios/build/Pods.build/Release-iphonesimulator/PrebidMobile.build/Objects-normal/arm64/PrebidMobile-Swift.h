...
typedef SWIFT_ENUM_NAMED(NSInteger, PBMAdPosition, "AdPosition", closed) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, PBMClickbrowserType, "ClickbrowserType", closed) {
...
typedef SWIFT_ENUM(NSInteger, DataAsset, closed) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, PBMGender, "Gender", closed) {
  PBMGenderUnknown = 0,
  PBMGenderMale = 1,
  PBMGenderFemale = 2,
  PBMGenderOther = 3,
...
typedef SWIFT_ENUM_NAMED(NSInteger, PBMNetworkType, "NetworkType", closed) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, PBMPosition, "Position", closed) {
...
typedef SWIFT_ENUM(NSInteger, PrebidInitializationStatus, closed) {
